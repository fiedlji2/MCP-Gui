function addr = address( adr )
    ...
    elseif strcmp(adr,'K4')                   addr = [0 hex2dec('13') hex2dec('A2') 0 hex2dec('40') hex2dec('B5') hex2dec('99') hex2dec('BB')];
    elseif strcmp(adr,'K5')                   addr = [0 hex2dec('13') hex2dec('A2') 0 hex2dec('40') hex2dec('B5') hex2dec('99') hex2dec('B4')];
    elseif strcmp(adr,'K6')                   addr = [0 hex2dec('13') hex2dec('A2') 0 hex2dec('40') hex2dec('B5') hex2dec('99') hex2dec('AD')];
